        ...
        <div class="card" style="margin-top:30px;">
            <div class="card-body">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a wire:click="companyDetailStore()" style="padding: .1rem 1rem;"
                            class="nav-link {{ $tab == '6' ? 'active' : '' }}" href="#">SHARE HOLDER TYPR</a>
                    </li>
                    <li class="nav-item">
                        <a wire:click="companyDetailStore()" style="padding: .1rem 1rem;"
                ...
                <div class="col-md-12" style="margin-top:30px;">
                    <label for="all_share_holder" class="form-label">Share holder {{ $count }}</label>
                    <select wire:model="all_share_holder.{{ $count }}" class="form-select" aria-label="Default select example">
                    <option value="" hidden>Select</option>
                    <option value="1">Person</option>
                    <option value="2">Company</option>
                  
                </select>
                @error('all_share_holder')
                <div style="color: red;">
                    {{ $message }}
                </div>
                @enderror       
                ...
                <div class="row">
                    <div class="col-12">
                        <br>
                        <button  class="btn btn-primary" type="button"
                            wire:target='share_holder_detail' wire:click.prevent='share_holder_detail'>
