<div id="reasonDisplay">
    <div class="row">
        ...
        <div class="col-md-12" style="text-align: center">
            <b style="font-size: 20px;">Loan reason</b>
        </div>
        @foreach($loanReasons as $item)
        <div class="col-md-4" style="margin-top: 30px;">
            <div class="form-check form-switch">
                <input id="reasonchk{{ $item->id }}" onchange="pushVal({{ $item->id }})" name="val"
                    value="{{ $item->id }}" class="form-check-input" type="checkbox" />
        ...
        <div class="col-md-12 text-center">
            <b style="font-size: 30px;">Data not found</b>
        </div>
        @endif
    </div>
    <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-3">
            <button onclick="previosu()" class="btn btn-light">Previous</a>
        </div>
        <div class="col-md-3" style="text-align: right;">
            <button onclick="next()" class="btn btn-light">Next</button>
        </div>
        <div class="col-md-3"></div>
    </div>
</div>
<div id="loanAmount" style="display:none;">
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12" style="margin-top:30px;">
                <div class="input-group">
                    ...
                    <input id="amount" type="number" name="amount" class="form-control" placeholder="$">
                    

                </div>
                <span class="customspan" id="amountVali"></span>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3"></div>
        <div class="col-md-3">
            <button onclick="previousLoanReason()" class="btn btn-light">Previous</a>
        </div>
        <div class="col-md-3" style="text-align: right;">
            <button onclick="nextLoanForm()" class="btn btn-light">Next</button>
        </div>
        <div class="col-md-3"></div>
    </div>
</div>
