            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    ...
                    <div class="row align-items-center ">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Customer applied</h4>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        <table id="loan_application_table" class="table  table-striped">
                                            ...
                                            <tr class="loan_application_row" url="{{ route('loan-application-summary',['apply_loan_id'=>$quote->loan_application->id]) }}"  style="cursor: pointer" title="Show summary">
                                                {{-- <td>
                                                    @if($quote->status == '1')
                                                    <span class="badge badge-info p-2">Customer Applied<span>
                                                    @elseif($quote->status == '3')
                                                    <span class="badge badge-info p-2">Loan offer signed<span>
                                                    @elseif($quote->status == '4')
                                                    <span class="badge badge-info p-2">Loan offer disbursed<span>
                                                    @endif
                                                </td> --}}
