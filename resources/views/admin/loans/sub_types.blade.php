                    ...
                    <div class="row align-items-center ">
                        ...
                        <div class="col-md-4">
                            <div class="float-right d-none d-md-block">
                                <button onclick="resetFormFields()" type="button" id="add_loan_subtype_btn" data-toggle="modal" data-target="#LoanSubTypeModal" data-dismiss="modal" aria-label="Close" class="btn btn-primary "><i class="fa fa-plus-circle"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table id="tech-companies-1" class="table  table-striped">
                                            ...
                                            @foreach($items as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onclick="getLoanTypeDetail({{$item->id}})" class=" edit_loan_subtype_btn" data-toggle="tooltip" data-original-title="Edit">
