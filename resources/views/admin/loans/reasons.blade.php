                                            ...
                                            @foreach($items as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($item->status == 0)
                                                            <a href="{{ route('loan-reason-status',['id'=>$item->id,'status'=>'1']) }}" msg="Are you sure to activate this reason?" class=" change_status" data-toggle="tooltip" data-original-title="Activate">
                                                                <i class="m-2 fa fa-thumbs-up"></i>
                                                            </a>
                                                        @elseif($item->status == 1)
                                                            <a href="{{ route('loan-reason-status',['id'=>$item->id,'status'=>'0']) }}" msg="Are you sure to deactivate this reason?" class="  change_status" data-toggle="tooltip" data-original-title="Deactivate">
                                                                <i class="m-2 fa fa-thumbs-down"></i>
                                                            </a>
                                                        @endif
                                                        <a href="{{ route('loan-reason-status',['id'=>$item->id,'status'=>'2']) }}" msg="Are you sure to delete this reason?" class=" change_status" data-toggle="tooltip" data-original-title="Delete">
