                                ...
                                <div class="table-rep-plugin">
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="loan_application_row" style="@if(sizeof($application->assigned_application) && $application->assigned_application[0]->status != 0 && Auth::user()->parent_id != 0) background-color:#27b34d @endif" url="{{ route('loan-application-summary',['apply_loan_id'=>$application->id]) }}" title="Show summary" style="cursor: pointer;">
