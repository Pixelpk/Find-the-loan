        ...
        <div class="row">
            <div class="col-md-6">
             <div class="mb-3">
                ...
                <input wire:model="hirePurchase.amount" type="number" class="form-control mt-2" id="hirePurchase.amount">
...
<div class="row mb-3">
    ...
    <div class="col-md-3">
        ...
        :label="''"
        :apply_loan="$apply_loan" :main_type="$main_type" :loan_type_id="$loan_type_id" :share_holder="0"
        :modell="'App\Models\BusinessHirePurchase'" :keyvalue="'business_hire_purchase_vehicle_optional_document'" />
    </div>
    <!-- <div class="col-md-12">
        <div class="mb-3">
...
<hr>
    ...
    @if($hirePurchase['hire_purchase_type'] == 4 || $hirePurchase['hire_purchase_type'] == 5 || $main_type == 2)
        <div class="col-md-12">
            <b> Details of Seller. Ignore if individual seller </b>
        </div>
    @else
        <div class="col-md-12">
            <b>Details of premise where equipment/machinery will be kept and used</b>
        </div>
    @endif
...
<div class="row mt-3">
    @if($hirePurchase['hire_purchase_type'] == 4 || $hirePurchase['hire_purchase_type'] == 5 || $main_type == 2)
        ...
        <div class="col-md-4">
            <div class="mb-3">
                <label for="hirePurchase.salesman_number" class="form-label">Salesman Number </label>
                <input wire:model="hirePurchase.salesman_number" type="text" class="form-control" id="hirePurchase.salesman_number">
                @error("hirePurchase.salesman_number")
                <div style="color: red;">
                    {{ $message }}
                </div>
                @enderror
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                :share_holder="0"
                :modell="'App\Models\BusinessHirePurchase'"
                :keyvalue="'business_hire_purchase_agreement_optional'"/>
               <!--  @error("document")
                <div style="color: red;">
                    {{ $message }}
                </div>
