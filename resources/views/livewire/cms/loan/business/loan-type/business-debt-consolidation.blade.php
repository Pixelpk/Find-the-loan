                ...
                <div class="mb-3">
                    <label for="amount">Amount required
                        <div class="tooltip-c">
                            ...
                            <span class="tooltip-text custom-tooltip-text">Amount required is the amount you are aiming to
                                borrow for that loan type. You may still reduce it prior to signing Loan Offer
                                Letter.</span>
                        </div>
                    </label>
