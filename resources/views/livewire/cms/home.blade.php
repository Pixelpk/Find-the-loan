           ...
           <div class="container">
               <div class="loan-type__icon">
                ...
                <div class="card">
                    <div class="card-body">
                     <div class="icon-circle mx-auto mb-3">
                        <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tir" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <div class="card">
                    <div class="card-body">
                     <div class="icon-circle mx-auto mb-3">
                        <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cash" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <div class="card">
                    <div class="card-body">
                     <div class="icon-circle mx-auto mb-3">
                        <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-backhoe" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
<div class="row align-items-center">
    <div class="col-sm-12 col-md-6 col-lg-8 pt-3">
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
      ...
      <div class="text-center ">
          <button class="btn change-way__btn">Apply Now</button>
        </div>
           </div>
       </section>
       <!-- /CHANGE THE WAY -->
