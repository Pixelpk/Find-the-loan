<main id="hero">
  <!-- HOME SLIDER -->
  <div class="about-slider sec-container position-relative" style="padding-top: 5.9rem">
    <div id="carouselExampleFade" class="carousel h-100 slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner h-100">
        ...
        <div class="carousel-item h-100">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h4 class="mb-0 animated slideInDown" style="animation-delay: 1s;">We believe no hardworking entrepreneurs
              should be allowed to fail due to disruption in cash flow and no individuals should be denied the
              opportunity to fulfil their dreams from poor access to financing.</h4>
          </div>
        </div>
        <div class="carousel-item h-100">
          <img class="d-block" src="{{ asset('assets/cms/img/Home/image2.jpg') }}" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
            <h3 class="fw-bold mb-0 animated slideInUp" style="animation-delay: 1s;">Getting a loan should <br> be
              easier</h3>
    ...
    <a href="#carouselExampleFade" role="button" data-slide="prev" class="mt-4 carousel-control-prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a href="#carouselExampleFade" role="button" data-slide="next" class="mt-4 carousel-control-next">
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="cookie-buttons text-center">
                ...
                <button type="button" class="btn btn-cookie btn-secondary" data-bs-dismiss="modal">No I hate
                  cookies</button>
              </div>
            </div>
          </div>
          ...
          <div class="card nmor-card text-center">
            <div class="card-body">
              <div class="icon-circle mx-auto mb-3">
                <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-users" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341"
              ...
              <hr>
              <p>Single interface to easily reach multiple lenders, no more grappling with different jargons, banks's
                website layout and product names.</p>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-4">
          <div class="card nmor-card text-center">
            <div class="card-body">
              <div class="icon-circle mx-auto mb-3">
                <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-clipboard-list" viewBox="0 0 24 24" stroke-width="1.5"
              ...
              <hr>
              <p>For business to home loans, get actual quotes directly from our lenders based on your credit profile,
                not some advertised rates, no broker involved.</p>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-4">
          <div class="card nmor-card text-center">
            <div class="card-body">
              <div class="icon-circle mx-auto mb-3">
                <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-alarm" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341"
                  fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              ...
              <hr>
              <p>Being able to reach so many lenders directly with just a single submission helps you in finding a
                competitive loan fast.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="loan-type__icon">
            <div class="card">
              <div class="card-body">
                <div class="icon-circle mx-auto mb-3">
                  <svg class="circle__icon" xmlns="http://www.w3.org/2000/svg"
                    class="icon icon-tabler icon-tabler-receipt-tax" width="28" height="28" viewBox="0 0 24 24"
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-sm-12 col-md-6 col-lg-8 pt-3 order-2 order-md-1">
          <P class="lea">Upload the documents required. our algorithm will guide you on what documents are
            required</P>
        </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-sm-12 col-md-6 col-lg-8 pt-3 ps-md-3">
          <P class="lea">Compare and select who offer the highest quantum, logest tenure, lowest fee or
            interest, after our financing partners compete to offer you a loan.</P>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-5">
          <div class="compare__icon w-100 h-100 text-center text-lg-end">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-files" width="250" height="250"
        ...
        <div class="col-sm-12 col-md-6 col-lg-7">
          <div class="compare__content">
            ...
            <p class="lea">Imagine 2 loans that are both $300,000 and 5 years long but 1 is at 3% and the
              other at 3.50% pa.</p>
            <p class="lea">That would you give a total interest of $45,000 vs $52,500-a difference of
              $7,500.</p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      {{-- <div class="row">
        <div class="col-12 col-lg-2">
          ...
          @if ($partner->image != '')
              <div class="card bg-black shadow w-100 h-75">
                <div class="card-body bg-inf h-100 p-1">
                  <img class="img-fluid h-100 w-100" src="{{ asset('uploads/financePartnerImages/' . $partner->image) }}"
                    alt="">
                </div>
              </div>
          @endif
            ...
            <div class="finance__card">
              <div class="card shadow">
                <div class="card-body p-1">
                  <img class="img-fluid" src="{{ asset('uploads/financePartnerImages/' . $partner->image) }}"
                    alt="">
