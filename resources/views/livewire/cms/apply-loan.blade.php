<div>
    ...
    <section class="section-white small-padding" style="margin-top: 50px;">
            ...
            <div class="card" style="margin-top:30px;">
                <div class="card-body">
                    ...
                    {{-- <div class="row">
                        <div class="col-12">
                            <br>
                            <button @if(!$loan_type_id) disabled @endif class="btn" type="button"
        ...
        {{-- <div class="row">
                        <div class="col-12">
                            <br>
                            <button class="btn" type="button" wire:target='storeReason'
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top:30px;">
                <div class="form-check">
                    <input wire:model="lender.{{ $financePartner->id }}" class="form-check-input" type="checkbox"
                        value="" id="{{ $financePartner->id }}">
...
@for ($count = 1; $count <= $apply_loan->parentCompany->number_of_share_holder; $count++) <div class="col-md-12"
    ...
    <div class="col-12">
        <br>
        <button class="btn" type="button" wire:target='share_holder_detail' wire:click.prevent='share_holder_detail'>
