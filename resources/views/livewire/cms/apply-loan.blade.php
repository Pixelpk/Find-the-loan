<div>
    ...
    <section class="section-white small-padding" style="margin-top: 50px;">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a wire:click="$set('tab', '8')" style="padding: .1rem 1rem;"
                                class="{{ !$main_type || !$loan_type_id ? 'disabled' : '' }} nav-link {{ $tab == '8' ? 'active' : '' }}"
                        ...
                        {{-- <li class="nav-item">
                            <a wire:click="goToReasons()" style="padding: .1rem 1rem;"
                                class="{{ !$reasonDisable ? 'disabled' : '' }} nav-link
                        {{ $tab == '2' ? 'active' : '' }}"
                        href="#">REASON</a>
                        </li> --}}
                        {{-- <li class="nav-item">
                            <a wire:click="storeReason()" aria-disabled="true" style="padding: .1rem 1rem;"
                                class="{{ !$loan_type_id ? 'disabled' : '' }} nav-link
                        {{ $tab == '3' ? 'active' : '' }}"
                        href="#">AMOUNT</a>
                        </li> --}}
                        ...
                        {{-- @if($apply_loan && $apply_loan->parentCompany && (int)$apply_loan->parentCompany->number_of_share_holder > 0) --}}
                        {{-- @if(!$this->listed_company_check) --}}
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a wire:click="$set('tab', '7')" style="padding: .1rem 1rem;"
                                class="{{ !$shareDisable ? 'disabled' : '' }} nav-link {{ $tab == '7' ? 'active' : '' }}" href="#">SHAREHOLDER</a>
                        </li>
                        {{-- @endif --}}
                        @endif
                        {{-- @endif --}}
                        ...
                        <div x-data="{ isUploading: false, progress: 0 }"
                            ...
                            <div class="form-group">
                                ...
                                <label wire:ignore class="label" data-toggle="tooltip" title="Select Image">
                                    <input wire:model="gernalinfo.{{ $item['key'] }}" type="{{ $item['type'] }}"
                                        id="vehicleimage">
                                </label>
                            </div>
                            @error('subsidiary')
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <input wire:model="gernalinfo.{{ $item['key'] }}" class="form-check-input" type="checkbox"
                                value="" id="{{  $item['label'] }}">
                    ...
                    <div class="col-md-6" style="margin-top: 30px;">
                        ...
                        <input wire:model="gernalinfo.{{ $item['key'] }}" type="number" class="form-control"
                            id="amount">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <br>
                            <button class="btn btn-primary" type="button" wire:target='store'
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-top: 30px;">
                            <div class="form-check form-switch">
                                <input wire:click="pushReason({{ $item->id }})"
                    wire:model="reasonValue.{{ $item->id }}" class="form-check-input reasonCheck"
        ...
        <div class="row">
            <div class="col-12">
                <br>
                <button wire:loading.attr='disabled' class="btn btn-primary" type="button" wire:target='companyDetail'
        ...
        <div class="row">
            ...
            <div class="col-md-5" style="margin-top: 30px;">
                ...
                <div class="input-group">
                    <input wire:click="resetComapny()" placeholder="Number of years" wire:model="company_year"
            ...
            <div class="col-md-3" style="margin-top: 30px;">
                <div class="input-group" style="margin-top:29px;">
                    <input wire:click="resetComapny()" placeholder="Number of month" wire:model="company_month"
                        type="number" class="form-control" aria-label="Text input with dropdown button">
            ...
            <div class="col-md-5">
                ...
                <div class="input-group">
                    ...
                    <select {{ $company_year || $company_month ? 'disabled' : '' }} wire:model="company_years"
            ...
            <div class="col-md-3">
                <div class="input-group" style="margin-top:20px;">
                    <select {{ $company_year || $company_month ? 'disabled' : '' }} wire:model="company_months"
                        class="form-select" aria-label="Default select example">
                        <option value="" hidden>Select</option>
...
@for ($count = 1; $count <= $apply_loan->parentCompany->number_of_share_holder; $count++) <div class="col-md-12"
    ...
    <div class="col-12">
        ...
        <button class="btn btn-primary" type="button" wire:target='share_holder_detail'
            ...
            <span wire:loading wire:target="share_holder_detail" class="spinner-border spinner-border-sm" role="status"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-check" style="margin-top: 40px;">
               <select wire:model="checkShareHolder.{{ $item['id'] }}" wire:change="getShareholderTypeId({{ $item['id'] }})">
                    <option value="0">Person</option>
                    <option value="1">Company</option>
                </select>
                {{-- <input wire:model="checkShareHolder.{{ $item['id'] }}"
                    wire:change="getShareholderTypeId({{ $item['id'] }})" class="form-check-input" type="checkbox"
                    id="{{ $item['id'] }}">
                        ...
                        <div class="col-md-3 text-left" style="margin-top: 30px;">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="nric_front.{{ $shreholder }}" type="file" id="vehicleimage"
                                        name="" id="">
                                    </label>
                                </div>
                        ...
                        <div class="col-md-3 text-left" style="margin-top: 30px;">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="nric_back.{{ $shreholder }}" type="file" id="vehicleimage"
                                        name="" id="">
                                    </label>
                                </div>
                        ...
                        <div class="col-md-3 text-left" style="margin-top: 30px;">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="nao_latest.{{ $shreholder }}" type="file" id="vehicleimage"
                                        name="" id="">
                                    </label>
                                </div>
                        ...
                        <div class="col-md-3 text-left" style="margin-top: 30px;">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="nao_older.{{ $shreholder }}" type="file" id="vehicleimage"
                                        name="" id="">
                                    </label>
                                </div>
            ...
            <div wire:ignore.self id="collapseOne{{ $shreholder }}" class="collapse" aria-labelledby="{{ $shreholder }}"
                ...
                <div class="card-body">
                    <ul class="nav nav-pills">
                        ...
                        @if(isset($share_holder_listed_company_check[$shreholder]) && !$share_holder_listed_company_check[$shreholder])
                        <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br>
                            <div class="form-check form-switch">
                                <input wire:model="share_holder_listed_company_check.{{ $shreholder }}" class="form-check-input" type="checkbox"
                                    id="flexSwitchCheckDefault">
                    ...
                    <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-5" style="margin-top: 30px;">
                            <label for="share_holder_company_year.{{ $shreholder }}" class="form-label">How long has the
                                company
                                been in
                                business?</label>
                            <div class="input-group">
                        ...
                        <div class="col-md-4"></div>
                        <div class="col-md-6" style="margin-top: 30px;">
                            <label for="share_holder_percentage_shareholder.{{ $shreholder }}" class="form-label">% of
                                local
                                shareholding
                            </label>
                        ...
                        <div class="col-md-3 text-left">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input wire:model="share_holder_current_year.{{ $shreholder }}" type="file"
                                        id="vehicleimage" name="" id="">
                                </div>
