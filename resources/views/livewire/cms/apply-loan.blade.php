                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-primary" type="button"
                                        wire:target='share_holder_document_store'
                    ...
                    <div wire:ignore.self id="collapseOne{{ $shreholder }}" class="collapse"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-top:30px;">
                                <div class="col-md-12">
                                    <div class="form-check form-switch">
                                        <input wire:model="listed_company_check" class="form-check-input"
                                ...
                                <div class="col-md-6" style="margin-top: 30px;">
                                    <label for="share_holder_company_year.{{ $shreholder }}" class="form-label">How long
                                ...
                                <div class="col-md-6" style="margin-top: 30px;">
                                    <label for="share_holder_percentage_shareholder.{{ $shreholder }}"
                                        class="form-label">% of local shareholding
                                    </label>
                                ...
                                <div class="col-md-6" style="margin-top: 30px;">
                                    <label for="share_holder_number_of_employees" class="form-label">Number of full-time
                                        employee
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top: 30px;">
                                    <b>Current Year.</b>
                                    <p>If you are <b>more than 3-6 months into your current accounting year,</b> and if
                                        your
